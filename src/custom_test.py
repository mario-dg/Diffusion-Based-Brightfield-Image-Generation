...
def process_image(image_path):
    ...
    # Image.fromarray(closed_edges).show()
    # circles = cv2.HoughCircles(closed_edges, cv2.HOUGH_GRADIENT, dp=1.2, minDist=20, param1=50, param2=30, minRadius=5, maxRadius=50)
    # if circles is not None:
    #     circles = np.uint16(np.around(circles))
    #     return [(x, y, r*2, r*2) for x, y, r in circles[0, :]]
    # else:
    #     return []
